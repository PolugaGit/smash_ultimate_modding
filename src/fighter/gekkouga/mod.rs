...
unsafe extern "C" fn gekkouga_game_attackairf(agent: &mut L2CAgentBase) {
    ...
    if macros::is_excute(agent) {
        ...
        AttackModule::set_optional_hit_effect(agent.module_accessor, 0, Hash40::new_raw(0x148397b09f));
    }
...
pub fn install() {
    Agent::new("gekkouga")
        .game_acmd("game_attackairf", gekkouga_game_attackairf)
        .install();
}
